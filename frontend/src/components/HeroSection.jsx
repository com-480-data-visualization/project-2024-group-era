...
const HeroSection = () => {
  return (
    <header id='home' className='h-screen relative -mt-16'>
      <div className="absolute inset-0 z-0 bg-center bg-cover" style={{ backgroundImage: "url('https://media.cntraveller.com/photos/611befdcdb797d0116fd4d86/16:9/w_2580,c_limit/end.jpg')" }}></div>
